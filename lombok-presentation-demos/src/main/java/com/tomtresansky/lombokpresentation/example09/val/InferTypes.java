...
public class InferTypes {
  public static void main(final String... args) {
    ...
    // Inferred primitives work like primitives
    val i = 5;
    val j = i + 5;
    final int k = j * 2;
    ...
    System.out.println("\nA List might not be random access, but we can access the item at index 2 of our inferred ArrayList directly: " + list.get(2));
    ...
    // Most common superclass is used in case of compound types unknown until runtime
    ...
    whatAmI2.add("a");
    whatAmI2.add("b");
    // Doesn't work: whatAmI is typed as AbstractCollection, will always be an arraylist though
    //whatAmI2.get(0);
